    ...
    >
      ...
      <div className="p-5">
        <Link to={`/blog/${post.slug}`}>
          <h2 className="font-montserrat font-bold text-xl text-dark-hard truncate">
            {post.title}
          </h2>
          <p className="text-dark-soft mt-3 text-sm overflow-hidden line-clamp-3 h-16">{post.caption}</p>
        </Link>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-x-2">
                ...
                <span className="italic text-dark-soft text-xs">
                  {post.user.verified ? "verified" : "Unverified"} Master
                </span>
              </div>
            </div>
          </div>
